...
<title>eletronicos - Editar</title>
		...
		<div class="container">
			<div class="collapse navbar-collapse"
				...
				<ul class="nav navbar-nav">
					<li><a href="${contextPath}/eletronico">eletronicos</a></li>
				</ul>
			</div>
		</div>
	</nav>
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="well">
					...
					<form:form modelAttribute="eletronicoModel" action="${contextPath}/eletronico/${eletronicoModel.id}" method="put">
					
						<spring:hasBindErrors name="eletronicoModel">
						...
						<div class="form-group">
							...
							<form:input type="text" path="codigo" id="codigo"
								class="form-control" maxlength="50" size="50" />
							<font color="red"><form:errors path="codigo" /></font><br />
						</div>

						<div class="form-group">
							<label class="control-label" for="nota">Nota:</label>
							<form:input type="number" id="nota" path="nota"
								class="form-control" maxlength="14" size="15" />
							<font color="red"><form:errors path="nota" /></font><br />
						</div>
						...
						<a class="btn btn-default btn-lg" href="${contextPath}/eletronico">Cancelar</a>

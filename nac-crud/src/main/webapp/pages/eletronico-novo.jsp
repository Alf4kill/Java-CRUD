...
<title>Eletronico - Cadastro</title>
		...
		<div class="container">
			<div class="collapse navbar-collapse"
				...
				<ul class="nav navbar-nav">
					<li><a href="${contextPath}/eletronico">Eletronico</a></li>
				</ul>
			</div>
		</div>
	</nav>
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="well">
					...
					<form:form modelAttribute="eletronicoModel"
						action="${contextPath}/eletronico" method="post">
